...
import AttendencTable from "./AttendencTable";
import { IconViewAll } from "./utility/Icon";

export function StatsSection({AttendenceDetails}: {AttendenceDetails: any}) {
   ...
   console.log(showTable)
    ...
    <section className=" py-2">
      <div className="mx-auto grid max-w-lg grid-cols-2 gap-4">
        ...
        {showTable && <AttendencTable AttendanceDetails={AttendenceDetails} />}
      </div>
    </section>
  );
}
